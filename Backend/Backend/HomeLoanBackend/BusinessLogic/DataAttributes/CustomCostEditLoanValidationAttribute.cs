...
{
    internal class CustomCostEditLoanValidationAttribute:ValidationAttribute
    {
        ...
        {
            EditLoanApplicationDTO loan = (EditLoanApplicationDTO)validationContext.ObjectInstance;
